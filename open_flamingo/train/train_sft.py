...
from sft_data import make_supervised_data_module, DataCollatorForSupervisedDataset
from openflamingo_trainer import OpenFlamingoTrainer
from sft_data import rank0_print
...
def main():
    ...
    if args.fsdp:
        ...
        # model = DP(model, device_ids=[device_id])
    ...
    data_module = make_supervised_data_module(data_path=args.data_path, tokenizer=tokenizer, image_folder=args.image_folder, image_processor=image_processor)
